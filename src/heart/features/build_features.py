...
def build_categorical_pipeline() -> Pipeline:
    categorical_pipeline = Pipeline(
        [
            # TODO ADD SimpleImputer for Categorical Preprocessing
            ("ohe", OneHotEncoder()),
        ]
    )
...
def build_transformer(categorical_features: List[str], numerical_features: List[str]) -> ColumnTransformer:
    transformer = ColumnTransformer(
        [
            ...
            # TODO Numerical feature Pipeline
        ]
    )
    return transformer
